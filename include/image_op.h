...
image img_blend_if_scalar(
    image img, float_eq_fn, float comparee, image true_img, image false_img);
...
point2di horizontal_scan(image first_image,
                         image second_image,
                         int y,
                         int x,
                         int window_height,
...
typedef float (*wfn)(image first_image,
                     image second_image,
                     point2di st_p,
                     point2di nd_p,
                     tlbr_rect rect);
