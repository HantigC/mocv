...
image img_where_img(image img, float_eq_fn, image comparee, float true_value,
                     float false_value);
image img_where_lt_img(image img, image comparee, float true_value, float false_value);
image img_where_gt_img(image img, image comparee, float true_value, float false_value);
image img_where_eq_img(image img, image comparee, float true_value, float false_value);
image img_where_le_img(image img, image comparee, float true_value, float false_value);
image img_where_ge_img(image img, image comparee, float true_value, float false_value);

image img_blend_if_scalar(image img, float_eq_fn, float comparee, image true_img,
                           image false_img);
