...
image *img_mask_img(image *img, cmp_fn fn, image *comparee, float scalar);
...
image *img_where_scalar(image *img, cmp_fn, float comparee, float true_value,
                        float false_value);
...
image *img_where_img(image *img, cmp_fn, image *comparee, float true_value,
                     float false_value);
...
image *img_blend_if_scalar(image *img, cmp_fn, float comparee, image *true_img,
                           image *false_img);
